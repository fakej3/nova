...
query.addEventListener('submit',e=>{e.preventDefault();const text=input.value.trim();if(!text)return;core.neural.activate(text);layout();input.value='';});
