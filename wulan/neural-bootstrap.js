(() => {
  ...
  const timer=setInterval(()=>{
    ...
    clearInterval(timer);
    show('Neural runtime is taking longer than expected.','The visual field is still available while Wulan finishes loading its substrate. If it remains unavailable, check DevTools → Console and Network for wulan/neural-lab.js or one of its imports.');
  },250);
